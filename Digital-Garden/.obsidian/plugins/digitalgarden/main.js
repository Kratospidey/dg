...
var SettingView = class {
  ...
  initializeDefaultNoteSettings() {
    return __async(this, null, function* () {
      ...
      new import_obsidian3.Setting(noteSettingsModal.contentEl).setName("Show local graph for notes (dg-show-local-graph)").setDesc("When turned on, notes will show its local graph in a sidebar on desktop and at the bottom of the page on mobile.").addToggle((t) => {
